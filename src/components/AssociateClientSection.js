...
import './AssociateClientSection.css';

const DivisionDetailSection = () => {
    ...
    <div className='division-Detail'>
      <div className='division-Detail-section-1'>
        <div className='division-Detail-section-1-div1'>
          <Link to={'/AssociateClient'} style={{ textDecoration: "none"}}><div className='associate-client' style={{backgroundColor: 'White', color: '#f7a43c', padding: '4px',  fontWeight: '500'}}>Associate Client</div></Link>
        ...
        <Link to={'/AddAssociateClient'} style={{ textDecoration: "none"}}><button className="create-btn">Add Client</button></Link>
        </div> 
        <br />
        <Divider /> 
        <br />  
      <table className="table">
        <thead>
          <tr>
            <th className='tr-th-associate'>Client ID</th>
            <th className='tr-th-associate'>Client Name</th>
            <th className='tr-th-associate'>Division</th>
            <th className='tr-th-associate'>Action</th>
            </tr>
        </thead>
        <tbody>
          {data.map((row, index) => (
...
export default DivisionDetailSection;